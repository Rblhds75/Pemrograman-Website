...
<head>
    ...
    <title>Laporan Perbaikan dan Penggantian Aset</title>
</head>
<body>
<div class="nav">
    <div class="logo">
...
<div class="data">
    <h3>Laporan Perbaikan dan Penggantian Aset</h3>
    ...
    <table border="1">
        ...
        <?php
        $No = 1;
        $query = "SELECT perbaikan.*, aset.nama_aset, aset.kategori FROM perbaikan 
